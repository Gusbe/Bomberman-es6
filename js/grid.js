...
class Grid {
  ...
  constructor (canvas){
    ...
    this.powerUps = ['R','R','R','R','A','A','A','A','A','A','L','D'];  //R:Bomb range A:Bombs amount L:Slow enemies D:Death 
  ...
  configureBoard (){
    ...
    this.board[3] = ['W','S','X','X','X','S','X','S','X','X','X','X','W'];
  ...
  printElement = function(element, x, y){
