...
class Game {
    ...
    constructor (canvas, initCredits){
      this.grid = null;
      this.player = null;
    ...
    updateScreenCounters (numberOfBombs){
    ...
    setGameOverCallBack = function(buildGameOverScreen){  //To have access on fucntion in another files
      
      this.buildGameOverScreen = buildGameOverScreen;
    }
    
    setGameOverWithLifesCallBack = function(buildGameOverWithLifesScreen){  //To have access on fucntion in another files
      
      this.buildGameOverWithLifesScreen = buildGameOverWithLifesScreen;
    }
    
    setWinnerCallBack = function(buildWinnerScreen){  //To have access on fucntion in another files
